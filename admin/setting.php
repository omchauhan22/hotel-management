...
<body class="bg-light">
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control shadow-none" name="site_about" id="site_about_inp" rows="5" required></textarea>
                                    </div>
                                </div>
                ...
                <!-- Contacts details modal section  -->
    ...
    <script>
        ...
        let contatcs_s_form = document.getElementById('contacts_s_form');
        ...
        function upd_general(site_title_val, site_about_val) {
            ...
            xhr.onload = function() {
                ...
                var modal = bootstrap.Modal.getInstance(myModal); // Get Bootstrap modal instance
                modal.hide();
            ...
            xhr.send('site_title=' + encodeURIComponent(site_title_val) + '&site_about=' + encodeURIComponent(site_about_val));
        }
        ...
        contatcs_s_form.addEventListener('submit', function(e) {
            e.preventDefault();
            upd_contacts();
        })
        ...
        function add_member() {
            ...
            xhr.onload = function() {
                ...
                if (this.responseText == 'inv_img') {
                    alert('error', 'Invalid image format. Please upload a valid image.');
