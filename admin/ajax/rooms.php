...
if (isset($_POST['get_all_rooms'])) {
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        <td>$status</td>
        <td>
        <button type='button' onclick='edit_details($row[id])' class='btn text-primary shadow-none btn-sm fs-5' data-bs-toggle='modal' data-bs-target='#edit-room'>
        <i class='bi bi-pencil-square'></i>
        </button>
        <button type='button' onclick=\"room_images($row[id],'$row[name]')\" class='btn text-dark shadow-none btn-sm fs-5' data-bs-toggle='modal' data-bs-target='#room-images'>
        <i class='bi bi-images'></i>
        </button>
        <button type='button' onclick='remove_room($row[id])' class='btn text-danger shadow-none btn-sm fs-5'>
...
if (isset($_POST['rem_image'])) {
    ...
    if ($res && mysqli_num_rows($res) > 0) {
        ...
        echo 0; // No matching record found
    }
}
