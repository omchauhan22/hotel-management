...
<head>
    ...
    <title>VK hotel - Room Details</title>
                    ...
                    <div class="carousel-inner">
                        ...
                        if (mysqli_num_rows($img_q) > 0) {
                            ...
                            <div class='carousel-item $active_class'>
                                <img src='" . ROOMS_IMG_PATH . $img_res['image'] . "' class='d-block w-100 rounded' alt='...'>
                            </div>
                            ";
                                $active_class = '';
                            }
            ...
            <div class="col-lg-5 col-md-12 px-4">
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        ...
                        echo <<<book
                                <a href="#" class="btn w-100 text-white custom-bg shadow-none mb-">Book now</a>
                        book;
            ...
            <div class="col-12 mt-4 px-4">
                ...
                <div class="review-rating">
                    ...
                    <div>
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque debitis unde sit magni, aspernatur enim asperiores architecto molestiae incidunt hic culpa totam ex officiis velit necessitatibus porro voluptatibus animi id.
                        </p>
                        <div class="rating">
                            <i class="bi bi-star-fill text-warning"></i>
                            <i class="bi bi-star-fill text-warning"></i>
